...
- (id)initWithServerURL:(NSURL *)url username:(NSString *)username password:(NSString *)password repository:(NSString*)repository;
...
+ (NUXSession *)sharedSessionWithPlistFile:(NSString*)plistName;
